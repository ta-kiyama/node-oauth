...
OAuthPrototype.getAsync = function(url, oauth_token, oauth_token_secret) {
  var _this = this;

  return new Promise(function(resolve, reject){
    _this.get.call(_this, url, oauth_token, oauth_token_secret, _performSecureRequestCallback(resolve, reject));
  });
};
